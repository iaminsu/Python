...
path = "/Users/insuhong/Dropbox/research/Distance restricted covering model/Locating recharging station/data6/"
ffDict = "FF_Dictsites.shp_sites.shp_obstacles.shp.txt"
path_results = "/Users/insuhong/Dropbox/research/Distance restricted covering model/Locating recharging station/results_2/"

obstacles_f = "obstacles"

fdDict = "FD_Dictsites.shp_demands.shp_obstacles.shp.txt"
demand_Dict = "demands.txt"
facilities_f = "sites.shp"
...
p = 25  #number of stations to be sited including existing warehouses 
...
while temperature > 0.5:
    ...
    current_graph = delivery_network_mk2(current_solution, False, "currrent_graph")
    ...
    n_graph = delivery_network_mk2(new_solution, False, "greey_graph")
    e_time = time.time()
    s_time = time.time()
    new_solution = spatial_interchage_mk6(new_solution)
    e_time = time.time()

    new_graph = delivery_network_mk2(new_solution, False, "new_solution")
...
if solution_obj > best_solution[1]:
    ...
    f_result.write("Final solution: " + str(solution_sites) + "\n")
    f_result.write("Objective value_r: " +  str(solution_obj) +"\n")
    f_result.write("Covered population: " +  str(cal_obj(solution_sites)) + "\n")
    ...
    final_graph = delivery_network_mk2(solution_sites, True, "final_solution_" + str(p) + "_" + str(random.random()))
